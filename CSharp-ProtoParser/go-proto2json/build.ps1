...
$sha256_windows_x86 = (Get-FileHash $output_windows_x86 -Algorithm SHA256).Hash
...
$sha256_windows_x64 = (Get-FileHash $output_windows_x64 -Algorithm SHA256).Hash
...
$sha256_windows_arm64 = (Get-FileHash $output_windows_arm64 -Algorithm SHA256).Hash
...
$sha256_macosx_x86 = (Get-FileHash $output_macosx_x86 -Algorithm SHA256).Hash
...
$sha256_macosx_x64 = (Get-FileHash $output_macosx_x64 -Algorithm SHA256).Hash
...
$sha256_macosx_arm64 = (Get-FileHash $output_macosx_arm64 -Algorithm SHA256).Hash
...
$sha256_linux_x86 = (Get-FileHash $output_linux_x86 -Algorithm SHA256).Hash
...
$sha256_linux_x64 = (Get-FileHash $output_linux_x64 -Algorithm SHA256).Hash
...
$sha256_linux_arm64 = (Get-FileHash $output_linux_arm64 -Algorithm SHA256).Hash
...
"@ | Out-File ../ExecutableInvoke.Checksum.Output.cs
